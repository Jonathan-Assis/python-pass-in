...
class AttendeesHandler:
    ...
    def register(self, http_request: HttpRequest) -> HttpResponse:
        ...
        if event_attendees_count["attendeesAmount"] and event_attendees_count["maximumAttendes"] <  event_attendees_count["attendeesAmount"]:
    ...
    def find_attendees_from_event(self,  http_request: HttpRequest) -> HttpResponse:
        ...
        if not attendees:
            raise HttpNotFoundError("Participantes não encontrado")
